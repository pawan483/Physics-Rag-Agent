...
• Fundamental particles are vibrating strings (~10⁻³⁵ m)
• Requires **10 dimensions** (9 space + 1 time)
• Extra dimensions compactified as **Calabi–Yau manifolds**
• 5 consistent theories unified by **M-Theory (11D)**
• Predicts gravity via closed strings
...
{context[:1000]}...
    ...
    return f"{answer}\n\n📚 **Sources Used**: {len(docs)} physics documents"
